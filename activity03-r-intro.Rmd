...
**Response**:The first error was in uppercase, it had a double "
The second issue was in punctuation and for " to show up you have to do \"
...
**Response**: cbind makes each vector a column, whereas c() just makes it one long vector.
...
**Response**: length() gives the number of variables, while nrow() gives the number of observations.
...
**Response**: The activity used a lot of different functions to modify vectors and matrices. The biggest thing that I noticed was the need to store evey function you did.
